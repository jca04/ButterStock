  ...
  const loadingPage = () => {
    ...
    return (
      <div className="div-loading">
        <div>
          <AiOutlineLoading3Quarters className="img-load" /> Verificando
        </div>
      </div>
    );
  };
          ...
          <Formik
            ...
            onSubmit={async (values, actions) => {
              ...
              try {
                ...
                const response = await verifiedRestaurant(values.restaurant);
                if (response.data !== undefined) {
                  ...
                  } else if (resData === "restaurant doesn´t exist") {
            ...
            {({ handleSubmit, values, touched, isSubmitting, errors }) => (
              ...
              >
                <div className="div-input">
                  <label htmlFor="restaurant">Nombre restaurante</label>
                  <Field
                    ...
                    style={
                      errors.restaurant &&
                      touched.restaurant && { border: "1px solid red" }
                    }
                  />
                  <div>
                ...
                <div className="div-input">
                  ...
                  <Field
                    ...
                    style={
                      errors.ciudad &&
                      touched.ciudad && { border: "1px solid red" }
                    }
                  />
                  <div>
                    {errors.ciudad && touched.ciudad && (
                      <p className="error">{errors.ciudad}</p>
                    )}
                  </div>
                </div>
                <div className="div-input">
                  ...
                  <Field
                    ...
                    style={
                      errors.direccion &&
                      touched.direccion && { border: "1px solid red" }
                    }
                  />
                  <div>
                ...
                >
                  {isSubmitting ? <AiOutlineLoading3Quarters /> : "Enviar"}
                </button>
              </Form>
            )}
          </Formik>
        ...
        <section className="child child1">
          <Formik
            ...
            onSubmit={async (values, actions) => {
              ...
              FormRestaurant.append("restaurant", saveRestarunt.restaurant);
              FormRestaurant.append("ciudad", saveRestarunt.ciudad);
              FormRestaurant.append("direccion", saveRestarunt.direccion);
              FormRestaurant.append("image", fileState);

              try {
                const response = await createRestaurant(FormRestaurant);
                if (response.data !== undefined) {
              ...
              <Form onSubmit={handleSubmit} className="form">
                <div className="div-input">
                  ...
                  <Field
                    ...
                    style={
                      errors.nombreUser &&
                      touched.nombreUser && { border: "1px solid red" }
                    }
                  />
                  <div>
                    {errors.nombreUser && touched.nombreUser && (
                      <p className="error">{errors.nombreUser}</p>
                    )}
                  </div>
                </div>
                <div className="div-input">
                  ...
                  <Field
                    ...
                    style={
                      errors.apellidoUser &&
                      touched.apellidoUser && { border: "1px solid red" }
                    }
                  />
                  <div>
                    {errors.apellidoUser && touched.apellidoUser && (
                      <p className="error">{errors.apellidoUser}</p>
                    )}
                  </div>
                </div>
                <div className="div-input">
                  ...
                  <Field
                    ...
                    style={
                      errors.correoUser &&
                      touched.correoUser && { border: "1px solid red" }
                    }
                  />
                  <div>
                    {errors.correoUser && touched.correoUser && (
                      <p className="error">{errors.correoUser}</p>
                    )}
                  </div>
                </div>
                <div className="div-input">
                  ...
                  <Field
                    ...
                    style={
                      errors.contraseña &&
                      touched.contraseña && { border: "1px solid red" }
                    }
                  />
                  <div>
