                    ...
                    {selectedData.map((row, index) => {
                      return (
                        <tr key={index}>
                          ...
                          {row.id_receta != undefined && row.sub_receta == 0 ? (
                            <td>Receta</td>
                          ) : null}
                          {row.id_receta != undefined && row.sub_receta == 1 ? (
                            <td>Adicion</td>
                          ) : null}
                          ...
                          {row.id_receta != undefined ? (
                            ...
                            <td>
                              <input
                                className="input-salida"
                                onChange={(e) =>
                                  handleSend(row.id_ingrediente, e, "cantidad")
                                }
                          ...
                          {row.id_receta != undefined ? (
                            ...
                            <td>
                              <select
                                onChange={(e) =>
                                  handleSend(row.id_ingrediente, e, "unidad")
                                }
                                className="input-salida"
                                required
                              >
